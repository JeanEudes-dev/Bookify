...
const Share: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="main">
                <div className="up">
                    <button type='button' onClick={handleCopyUrl} title='card1' className="card1">
                    ...
                    <button type='button' onClick={handleCopyUrl} title='card1' className="card2">
                ...
                <div className="down">
                    <button type='button' onClick={handleCopyUrl} title='card1' className="card3">
                    ...
                    <button type='button' onClick={handleCopyUrl} title='card1' className="card4">
